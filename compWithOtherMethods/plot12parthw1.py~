...
dataSRG = loadtxt("12part10/12part.dat")
dataCCSD = loadtxt("12part10/CCSD.dat")
dataCCSDHO = loadtxt("12part10/CCSDHO.dat")

l = len(dataSRG[:,0])
data7 = zeros(l)
data7[:] = 65.7001

axis([5,20,65.55, 67.7])
...
#title(r'$N=12,\;\omega=1.0$', fontsize=20, horizontalalignment='center')
...
savefig('12parthw1.pdf', format='pdf')
