...
dataSRG = loadtxt("30part10/30part.dat")
dataCCSD = loadtxt("30part10/CCSD.dat")
...
#title(r'$N=30,\;\omega=1.0$', fontsize=20, horizontalalignment='center')
...
savefig('30parthw1.pdf', format='pdf')
