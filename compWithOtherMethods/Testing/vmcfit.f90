...
!
      SUBROUTINE  vmcfit
      IMPLICIT NONE
      INTEGER :: i, number_of_data, number_terms, j
      ...
      DOUBLE PRECISION :: d, eee, f, g, h, x3, x1, x2
      EXTERNAL eos_param
      ...
      DO i=1,number_of_data
         READ (5,*)n(i) , d, e(i)!, f, g, h, x3, x1, x2
      ENDDO
...
!     of numerical recipes
      ...
      WRITE(*,*) polynom_terms!, SQRT(variance(1))
      DO i=1,number_of_data
         x1 = 10**(n(i))
         x2 = x1**polynom_terms(2)
         x3 = 10**polynom_terms(1)
         WRITE(6,*) x1, x2*x3
      ENDDO
