...
dataSRG = loadtxt("6part028/6part.dat")
dataFCI = loadtxt("6part028/6partFCIStd.dat")
dataCCSD = loadtxt("6part028/CCSD.dat")
...
#title(r'$N=6,\;\omega=0.28$', fontsize=20, horizontalalignment='center')
...
savefig('6parthw028.pdf', format='pdf')
