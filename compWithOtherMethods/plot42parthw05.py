...
dataSRG = loadtxt("42part05/42part.dat")
dataCCSD = loadtxt("42part05/CCSD.dat")
...
#title(r'$N=42,\;\omega=0.5$', fontsize=20, horizontalalignment='center')
...
savefig('42parthw05.pdf', format='pdf')
