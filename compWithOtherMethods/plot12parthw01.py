...
dataSRG = loadtxt("12part01/12part.dat")
dataCCSD = loadtxt("12part01/CCSD.dat")
...
#title(r'$N=12,\;\omega=0.1$', fontsize=20, horizontalalignment='center')
...
savefig('12parthw01.pdf', format='pdf')
