...
dataSRG = loadtxt("30part028/30part.dat")
dataCCSD = loadtxt("30part028/CCSD.dat")
...
#title(r'$N=30,\;\omega=0.28$', fontsize=20, horizontalalignment='center')
...
savefig('30parthw028.pdf', format='pdf')
