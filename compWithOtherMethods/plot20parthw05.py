...
dataSRG = loadtxt("20part05/20part.dat")
dataCCSD = loadtxt("20part05/CCSD.dat")
...
#title(r'$N=20,\;\omega=0.5$', fontsize=20, horizontalalignment='center')
...
savefig('20parthw05.pdf', format='pdf')
