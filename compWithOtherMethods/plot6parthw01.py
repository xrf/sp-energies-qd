...
dataSRG = loadtxt("6part01/6part.dat")
dataCCSD = loadtxt("6part01/CCSD.dat")
...
#title(r'$N=6,\;\omega=0.1$', fontsize=20, horizontalalignment='center')
...
savefig('6parthw01.pdf', format='pdf')
