...
dataSRG = loadtxt("12part05/12part.dat")
dataCCSD = loadtxt("12part05/CCSD.dat")
...
#title(r'$N=12,\;\omega=0.5$', fontsize=20, horizontalalignment='center')
...
savefig('12parthw05.pdf', format='pdf')
