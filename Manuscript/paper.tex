...
we start with the Wegner generator. Numerical instabilities in
...
subsection \ref{subsec:White} to the White generator. In particular, we
...
different generators, Wegner and White generators, and realized that
the Wegner generator results in stiff equation systems, whereas the White
...
previous FCI \cite{2008arXiv0810.2644K} and CCSD \cite{PhysRevB.84.115302}
