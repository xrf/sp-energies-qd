...
The results of our addition and removal energy calculations are summarized in Fig.\ \ref{fig:add} and Fig.\ \ref{fig:rm} respectively.  The figures show the addition/removal energies for using the approaches mentioned in Section \ref{subsec:methodology}.  Where available, results from diffusion Monte Carlo (DMC) \cite{PhysRevB.84.115302} are shown as a dashed line.
