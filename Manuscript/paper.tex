...
The central theme of similarity renormalization group (SRG) methods is the application of a continuous sequence of unitary transformations on the Hamiltonian to evolve it into a band- or block-diagonal form, see for examples Refs.\ \cite{kehrein2006flow,Hergert2016165,lnp936} for derivations and calculational details.
