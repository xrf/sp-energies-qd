...
\begin{figure}
  ...
  \subfigure[Results for $N=6$ and $\omega=1.0$]{
    \label{fig:N6hw1}
    \includegraphics[width=0.38\linewidth]{figures/6parthw1.pdf}
  }
  \subfigure[Results for $N=6$ and $\omega=0.5$]{
    \label{fig:N6hw05}
    \includegraphics[width=0.38\linewidth]{figures/6parthw05.pdf}
  } \\
  \subfigure[Results for $N=6$ and $\omega=0.28$]{
    \label{fig:N6hw028}
    \includegraphics[width=0.38\linewidth]{figures/6parthw028.pdf}
  }
  \subfigure[Results for $N=6$ and $\omega=0.1$]{
    \label{fig:N6hw01}
    \includegraphics[width=0.38\linewidth]{figures/6parthw01.pdf}
  }
